...
abstract class Logger
{
     ...
     */
    public static function log(string $type = 'DEBUG', string|array $msg = null, string $name_log = ''): void
    {
        if (is_array($msg)) {
     ...
     * @param string $name_log
     */
    public static function custom(string $type = 'CUSTOM', string|array $msg = null, string $name_log = ''): void
    {

    ...
    public function display()
    {
        ...
        do
        {
            ...
            if(next($this->_path) && !empty($crumb['title']))
            {
                ...
                $html[] = Html::link($crumb['url'], 'A: '.$crumb['title'], "class=\"{$this->attrs['class_separator']}\"");
            }
            elseif(!empty($crumb['title']))
            {
                //$html[] = "<li><a href='javascript: void(0)'>{$crumb['title']}</a></li>";
                //$html[] = "<a href='javascript: void(0)' {$this->attrs['class_separator']}>{$crumb['title']}</a>";
                $html[] = "<a href='/' class=\"{$this->attrs['class_separator']}\">'B: '.{$crumb['title']}</a>";
            }
        ...
        if(is_null($this->attrs['separator']))
        {
            ...
            return "<div class='{$this->attrs['class_ul']}'>" . implode('', $html) . '</div>';
        }
        else
        {
            ...
            //return "<div class='{$this->attrs['class_ul']}'>" . implode("<a href='javascript: void(0)' {$this->attrs['class_separator']}>{$this->attrs['separator']}</a>", $html) . '</div>';
            return "<div class='{$this->attrs['class_ul']}'>" . implode("<a href='/' class=\"{$this->attrs['class_separator']}\">{$this->attrs['separator']}</a>", $html) . '</div>';
        }
    }
